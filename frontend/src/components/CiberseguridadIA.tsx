const CiberseguridadIA = () => {
  ...
  return (
    <div id="ciberseguridad" className="w-full bg-white py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-10 xl:gap-16">
          ...
          <div className="flex-1 w-full lg:max-w-xl flex flex-col gap-8">
            ...
            {/* Header */}
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-lime-50 border border-lime-200 rounded-full mb-5 shadow-sm">
              ...
              <p className="text-sm md:text-base text-gray-600 max-w-lg mb-6 leading-relaxed">
                ...
                Seguridad especializada para <span className="text-lime-600 font-semibold">MLOps</span> y <span className="text-lime-500 font-semibold">AI-as-a-Service</span>.
              </p>

              {/* Certificaciones badge - Inline */}
              <div className="flex flex-wrap gap-2">
                {certifications.map((cert, idx) => (
                  <div key={idx} className="px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-full flex items-center gap-1.5 transition-colors hover:bg-lime-50 hover:border-lime-200">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-2xl p-5 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-3">
                {threats.map((threat, idx) => (
                  <div key={idx} className="bg-white border border-gray-100 rounded-xl p-3 flex flex-col justify-between hover:border-gray-200 transition-colors shadow-sm">
                    <div className="flex justify-between items-start mb-2">
                      <span className="text-[11px] font-medium text-gray-700 leading-tight">{threat.name}</span>
