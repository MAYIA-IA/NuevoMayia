...
const EmpleadosDigitales = () => {
  ...
  return (
    <div id="empleados-digitales" className="w-full bg-white py-12 lg:py-16 relative overflow-hidden flex flex-col justify-center min-h-screen lg:min-h-0">
        ...
        <div className="flex flex-col 2xl:flex-row items-center gap-8 2xl:gap-12">
          ...
          <div className="w-full 2xl:w-5/12 flex flex-col">
            ...
            <div className="text-left mb-6">
              ...
              {/* Trust badge */}
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-lime-400/10 to-lime-600/10 border border-lime-300 rounded-full backdrop-blur-sm">
                <svg className="w-4 h-4 text-lime-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                </svg>
                <span className="text-xs font-semibold text-lime-700">100% Confidencialidad</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              {stats.map((stat, index) => (
                <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-3 flex items-center gap-3 hover:bg-lime-50 hover:border-lime-200 transition-all duration-300">
                  <div className="w-10 h-10 bg-gradient-to-br from-lime-400/20 to-lime-600/20 rounded-lg flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-gray-500 uppercase tracking-wide leading-tight">{stat.label}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-center">
                ...
                <button className="text-gray-600 font-semibold text-xs flex items-center gap-1 hover:text-lime-600 transition-colors">
                  Ver casos de éxito
                </button>
              </div>
            </div>
