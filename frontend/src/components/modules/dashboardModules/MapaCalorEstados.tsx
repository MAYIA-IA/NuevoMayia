...
import { mexicoEstadosPaths as estadosPaths } from './mexicoStatePaths';
...
export const MapaCalorEstados: React.FC = () => {
  ...
  const mapPaths = useMemo(() => {
    return estadosPaths.map(({ id, path }) => {
  ...
  }, [filtroRegion, hoveredEstado, selectedEstado, colores, maxCasos]);
